...
def main():
    ...
    LLM_EVAL_PATH = r"DS3_APT2\llm_3_evaluation_results.json"
    TRADITIONAL_EVAL_PATH = r"DS3_APT2\trad-2-multilabel_metrics.json"
    NO_TAGGING_EVAL_PATH = r"DS3_APT2\no-tagging_evaluation_results.json"
    SUMMARY_EVAL_PATH = r"DS3_APT2\summary_evaluation_results.json"
    OUTPUT_DIR = r"DS3_APT2\comparison_results"
