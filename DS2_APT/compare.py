...
def main():
    ...
    LLM_EVAL_PATH = r"DS2_APT\llm_3_evaluation_results.json"
    TRADITIONAL_EVAL_PATH = r"DS2_APT\trad-2-evaluation_results.json"
    NO_TAGGING_EVAL_PATH = r"DS2_APT\no-tagging_evaluation_results.json"
    SUMMARY_EVAL_PATH = r"DS2_APT\summary_evaluation_results.json"
    OUTPUT_DIR = r"DS2_APT\comparison_results"
