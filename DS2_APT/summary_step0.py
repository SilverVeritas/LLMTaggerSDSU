...
def main():
    ...
    SUMMARIES_JSON_PATH = r'DS2_APT\summary_documents.json'
    KEYWORDS_JSON_PATH = r'DS2_APT\summary_extracted_keywords.json'
    LABELS_JSON_PATH = r'DS2_APT\summary_generated_labels.json'
    EVAL_JSON_PATH = r'DS2_APT\summary_evaluation_results.json'
    MODEL = 'gpt-4o'  
