...
def main():
    ...
    LLM_EVAL_PATH = r"Results\ds2\llm_3_evaluation_results.json"
    TRADITIONAL_EVAL_PATH = r"Results\ds2\trad-2-evaluation_results.json"
    OUTPUT_DIR = r"Results\ds2/comparison_results"
