...
def main():
    ...
    LLM_EVAL_PATH = r"Results\ds3\llm_3_evaluation_results.json"
    TRADITIONAL_EVAL_PATH = r"Results\ds3\trad-2-multilabel_metrics.json"
    OUTPUT_DIR = r"Results\ds3/comparison_results"
