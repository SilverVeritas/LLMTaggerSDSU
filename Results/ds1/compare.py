...
def main():
    ...
    LLM_EVAL_PATH = r"Results\ds1\llm_3_evaluation_results.json"
    TRADITIONAL_EVAL_PATH = r"Results\ds1\trad-2-evaluation_results.json"
    OUTPUT_DIR = r"Results\ds1/comparison_results"
